...
var LabelableContext = React5.createContext({
  controlId: void 0,
...
function useLabelableContext() {
  return React5.useContext(LabelableContext);
}
...
var LabelableProvider = function LabelableProvider2(props) {
  ...
  const [controlId, setControlIdState] = React6.useState(initialControlId);
  const [labelId, setLabelId] = React6.useState(props.labelId);
  const [messageIds, setMessageIds] = React6.useState([]);
  ...
  const getDescriptionProps = React6.useCallback((externalProps) => {
    return mergeProps({
...
var FieldError = React14.forwardRef(function FieldError2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
  ...
  const errorRef = React14.useRef(null);
  const [lastRenderedMessage, setLastRenderedMessage] = React14.useState(null);
  const [lastRenderedMessageKey, setLastRenderedMessageKey] = React14.useState(null);
...
var FieldDescription = React15.forwardRef(function FieldDescription2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
...
function useRegisterFieldControl(controlRef, params) {
  ...
  const sourceRef = React17.useRef(null);
...
function useLabelableId(params = {}) {
  ...
  const hasRegisteredRef = React18.useRef(false);
  const hadExplicitIdRef = React18.useRef(id != null);
...
// node_modules/@base-ui/react/esm/field/control/FieldControl.js
var FieldControl = React19.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React20.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React20.useMemo(() => {
    return {
  ...
  return (0, import_jsx_runtime4.jsx)(React20.Fragment, {
...
var FieldItemContext = React21.createContext({
  disabled: false
});
...
var CheckboxGroupContext = React22.createContext(void 0);
...
var FieldItem = React23.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const fieldItemContext = React23.useMemo(() => ({
    disabled: disabled2
  }), [disabled2]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
